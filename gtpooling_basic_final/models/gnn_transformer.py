...
class GNNTransformer(BaseModel):
    ...
    def forward(self, batched_data, perturb=None):
        ...
        # TODO: update src padding mask during topk
        ...
        if self.num_encoder_layers > 0:
            transformer_out, transformer_noise, _, idxs = self.transformer_encoder(transformer_out, src_padding_mask)  # [s, b, h], [b, s]
        ...
        if self.max_seq_len is None:
            ...
            noise = self.graph_pred_linear(noise_h_graph)
            return out, noise
        pred_list = []
        noise_list = []
